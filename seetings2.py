...
Obj_1_col = GREEN                            #### CHAAAAAANGE
Obj_1_radius = 10                            #### CHAAAAAANGE
Obj_1_weight = 600                            #### CHAAAAAANGE
Velocity1 = [0, .9] ## Right, up            #### CHAAAAAANGE
Obj_2_col = RED                             #### CHAAAAAANGE
Obj_2_radius = 20                           #### CHAAAAAANGE
Program_slowdown_percent = 200                #### CHAAAAAANGE
True_velocity1 = [0,0]
### SETTINGS DONE 

Obj_2_coords = [200, 0];                      #### CHAAANGE 
Obj_2_weight = 900                          #### CHAAAANGE
Velocity2 = [0, -.6]                          #### CHAAANGE
